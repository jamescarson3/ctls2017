...
However, understanding what the different types of errors are
and when you are likely to encounter them can help a lot.
Once you know *why* you get certain types of errors, they become much easier to fix.

Errors in Python have a very specific form,
called a [traceback](python_reference.md#traceback).
Let's examine one:
...
So, in this case, the program first performed a [function call](python_reference.md#function-call) to the function `favorite_ice_cream`.
...
Additionally, sometimes just knowing *where* the error occurred is enough to fix it,
...
you will encounter a [syntax error](python_reference.md#syntax-error).
...
> Because they are both [whitespace](python_reference.md#whitespace),
...
However, there are a few very common reasons why you might have an undefined variable.
The first is that you meant to use a [string](python_reference.md#string), but forgot to put quotes around it:
...
Remember that variables are [case-sensitive](python_reference.md#case-sensitive),
...
and they answered "caturday", you might be a bit annoyed.
...
Here, Python is telling us that there is an `IndexError` in our code,
...
If you get an error that you've never seen before, searching the Internet for that error type

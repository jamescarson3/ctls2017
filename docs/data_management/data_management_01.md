...
<tr><th> <strong>Assessment activities:</strong> </th></tr>
...
<tr><th> <strong>Assessment activities:</strong> </th></tr>
<tr><td><ul><li> On the command line, find different storage spaces on TACC HPC resources (e.g. Lonestar). </li><li> On the command line, determine the free disk space, as well as disk usage, age, and size for various files and directories. </li></ul></td></tr>
</tbody></table>
...
<tr><th> <strong>Assessment activities:</strong> </th></tr>
<tr><td><ul><li> Create zip files at various levels of compression and compare their file size vs. time required to zip. </li><li> Copy data from one place to another with `scp` vs. `scp –C` and report speedup. </li></ul></td></tr>
</tbody></table>
...
<tr><th> <strong>Assessment activities:</strong> </th></tr>
<tr><td><ul><li> Dedupe some sample data? </li><li> Tinker with file and directory permissions using chmod and access control lists. </li></ul></td></tr>
</tbody></table>
